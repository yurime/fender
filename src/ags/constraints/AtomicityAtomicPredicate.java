...
public class AtomicityAtomicPredicate extends AtomicPredicate implements
		Comparable {
	private int lhsID;
	private int rhsID;

	protected AtomicityAtomicPredicate(int lhsLabel, int rhsLabel) {
		this.lhsID = lhsLabel;
		this.rhsID = rhsLabel;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AtomicityAtomicPredicate other = (AtomicityAtomicPredicate) obj;
	...
	public boolean implies(Formula other) {
		...
		if (other instanceof AtomicityAtomicPredicate) {
	...
	public int compareTo(Object o) {
		AtomicityAtomicPredicate other = (AtomicityAtomicPredicate) o;
		if (lhsID < other.lhsID) {
			return -1;
