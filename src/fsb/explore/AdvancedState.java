...
public abstract class AdvancedState extends State {
	protected final int numProcs;	
	...
	public AdvancedState(MProgram program, Validator validator, int numProcs)
	{
	...
	public AdvancedState(AdvancedState s)
	{
	...
	public boolean equals(Object obj) {
		...
		if (this == obj)
			return true;
		if (!(obj instanceof AdvancedState)) return false;	
	...
	public boolean isJoinable(AdvancedState other)
	{
		return false;
	}
	
	public boolean join(AdvancedState other)
	{
		return false;
	}
